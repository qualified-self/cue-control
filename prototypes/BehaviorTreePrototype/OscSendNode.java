...
class OscSendNode extends CueNode {
  ...
  public OscSendNode(String addrPattern, float preWait, float postWait) {
    this(addrPattern, addrPattern, null, preWait, postWait);
  }

  public OscSendNode(String addrPattern, String arg, float preWait, float postWait) {
    this(addrPattern+" "+arg, addrPattern, arg, preWait, postWait);
  }

  public OscSendNode(String description, String addrPattern, String arg, float preWait, float postWait) {
